...
export default function Dashboard() {
  ...
  return (
    ...
    <div className="space-y-6">
      ...
      {/* Welcome Banner */}
      <div className="relative bg-primary rounded-3xl p-8 shadow-xl overflow-hidden">
        {/* Decorative Shapes */}
        <div className="absolute -top-20 -right-20 w-40 h-40 bg-white/10 rounded-full"></div>
        <div className="absolute -bottom-10 -left-10 w-25 h-25 bg-white/5 rounded-full"></div>
        ...
        <div className="relative flex flex-col-reverse lg:flex-row items-center justify-between gap-4">
          ...
          <div className="flex justify-center flex-1">
            <img
              ...
              className="w-72 md:w-80 lg:w- object-contain"
            />
          </div>
        </div>
      </div>
